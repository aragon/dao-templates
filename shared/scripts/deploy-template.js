...
module.exports = async function deployTemplate(web3, artifacts, templateId, contractName) {
  ...
  if (!templateId) errorOut('Missing template id.')
  ...
  return deployer.deploy(templateId, contractName)
}
