...
module.exports = async (callback) => {
  ...
  const templateName = 'DemocracyTemplate'
  ...
  console.log(`creating APM package for Democracy template at ${template.address}`)

  await apm.newRepoWithVersion('democracy-template', owner, [1, 0, 0], template.address, 'ipfs:')
